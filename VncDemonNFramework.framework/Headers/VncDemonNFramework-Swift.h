...
// Generated by Apple Swift version 6.1 effective-5.10 (swiftlang-6.1.0.106.4 clang-1700.0.9.2)
#ifndef VNCDEMONNFRAMEWORK_SWIFT_H
#define VNCDEMONNFRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VncDemonNFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
